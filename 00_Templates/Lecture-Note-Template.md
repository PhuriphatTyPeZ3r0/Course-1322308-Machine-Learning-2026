---
tags: [ml, week<N>, <แท็กหัวข้อ-1>, <แท็กหัวข้อ-2>]
course: 1322308
week: <N>
date: {{date}}
---
...
1. UML Activity Diagram (ค่าเริ่มต้นสำหรับ ขั้นตอน/อัลกอริทึม/Data Pipeline) -> ใช้ flowchart TD/LR พร้อมโหนด Start ((●)), Action ([...]), Decision {...}, End (((●)))
2. UML Sequence Diagram (ลำดับการสื่อสาร/การเรียก API/Agent workflow) -> ใช้ sequenceDiagram
3. UML State Machine Diagram (สถานะ FSM/วงจร/Lifecycle) -> ใช้ stateDiagram-v2
4. UML Class Diagram (โครงสร้างโมเดล/ความสัมพันธ์ข้อมูล) -> ใช้ classDiagram
